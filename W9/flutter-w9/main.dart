...
class ApplicationState extends ChangeNotifier {
  ...
  Future<DocumentReference> addMessageToGuestBook(String message) {
    ...
    return FirebaseFirestore.instance.collection('guestbook').add({
      'text': message,
      'timestamp': DateFormat("yyyy-MM-dd HH:mm:ss.S").format(DateTime.parse(DateTime.now().toString())),
          ...
          Row(
            ...
            children: [
              ...
              if(FirebaseAuth.instance.currentUser!.uid == '${message.userId}')
                ...
                onPressed: () {
                  FirebaseFirestore.instance.collection('guestbook').doc('${message.id}').delete();
                },
              ),
            ],
          ),
